...
const Dashboard = () => {
  ...
  const { files = [], recentFiles = [], fetchFiles, downloadFile, deleteFile, syncAll, trackRecentFile } = fileContext;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-lg text-gray-300">Manage and sync your files</p>
          </div>
        ...
        <div className="mb-8">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-6 border border-white/20">
            ...
            <p className="text-gray-300 mb-6">Organize your files by type</p>
            <FolderGrid />
          </div>
        </div>
